...
<body class="bg-white text-slate-800 antialiased selection:bg-[#0396c7] selection:text-white">
                ...
                <div class="lg:col-span-8 bg-[#eef6fc] p-10 sm:p-14 rounded-3xl border border-cyan-200 flex flex-col justify-between">
                    ...
                    <div class="mt-10 flex flex-wrap items-center gap-6 sm:gap-8 text-base sm:text-lg font-bold text-[#0396c7]">
                        <span class="flex items-center gap-2.5">
                            <span class="w-6 h-6 rounded-full bg-cyan-100 border border-[#0396c7] flex items-center justify-center text-xs font-black">✓</span>
                            100% Cepat
                        </span>
                        <span class="flex items-center gap-2.5">
                            <span class="w-6 h-6 rounded-full bg-cyan-100 border border-[#0396c7] flex items-center justify-center text-xs font-black">✓</span>
    ...
    {{-- ============================================================
        3. TEMPLATE (DINAMIS DARI DATABASE)
    ============================================================ --}}
                    ...
                    <div class="bg-white rounded-3xl overflow-hidden border border-slate-200 shadow-md flex flex-col justify-between hover:shadow-xl transition duration-200">
                        ...
                        <div class="p-8">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                @else
                                    <a href="{{ route('template.detail', $template->slug ?? $template->id) }}" class="w-1/2 py-3.5 text-center text-sm font-bold bg-slate-100 hover:bg-slate-200 text-slate-800 rounded-xl transition">
                                        Detail
                                    </a>
                                @endif
    ...
    {{-- ============================================================
        4. PRICING (DINAMIS DARI DATABASE)
    ============================================================ --}}
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-{{ count($packages) > 4 ? 4 : count($packages) }} gap-8 items-stretch">
                @foreach($packages as $pkg)
                    <div class="bg-white rounded-3xl p-8 flex flex-col justify-between transition {{ $pkg->is_popular ? 'border-2 border-[#0396c7] shadow-2xl relative transform lg:-translate-y-3' : 'border border-slate-200 shadow-sm hover:shadow-md' }}">
                        ...
                        @if($pkg->is_popular)
                        <div class="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#0396c7] text-white text-xs font-black uppercase tracking-wider px-5 py-1.5 rounded-full shadow-md whitespace-nowrap">
                            Paling Populer
                        </div>
                        @endif
                        ...
                        {{-- TOMBOL BIRU SEMUA --}}
                        <a href="{{ route('order.package') }}" class="block w-full mt-8 py-3.5 text-center text-sm font-black bg-[#0396c7] hover:bg-[#027ea7] text-white rounded-xl shadow-md transition">
                            Pilih Paket
                        </a>
                    </div>
                @endforeach
        ...
        <div class="max-w-6xl mx-auto px-6 sm:px-10">
            <div class="bg-[#0396c7] rounded-3xl p-12 sm:p-16 text-center text-white shadow-2xl">
                ...
                <p class="text-base sm:text-lg text-cyan-50 max-w-xl mx-auto mt-4 leading-relaxed font-medium">
                    ...
                    di Google. Mulai bangun eksistensi digital Anda hari ini
                    bersama Bisma Labs.
                </p>
