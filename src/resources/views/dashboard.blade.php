        ...
        <aside
            ...
            <div>
                ...
                <div class="h-20 flex items-center justify-between px-8 border-b border-slate-100">
                    <div>
                        <a href="{{ route('home') }}" class="flex items-center gap-2">
                            <img
                                ...
                                alt="Logo"
                                class="h-8 w-auto"
                                onerror="this.onerror=null;this.src='https://placehold.co/120x30/0396c7/ffffff?text=BismaLabs';">
                        </a>
                    ...
                    <button
                        @click="sidebarOpen = false"
                        class="lg:hidden text-slate-400 hover:text-slate-600 bg-slate-50 p-2 rounded-lg">
                ...
                <nav class="p-4 lg:p-6 space-y-2 mt-2 overflow-y-auto">
                    ...
                    <a
                        ...
                        class="flex items-center gap-4 px-5 py-3.5 bg-sky-50 text-sky-900 rounded-xl font-bold text-sm lg:text-base transition">

                        <svg
                            class="w-5 h-5 text-[#0369a1]"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24">
                    ...
                    <a
                        href="#"
                        class="flex items-center gap-4 px-5 py-3.5 text-slate-500 hover:bg-slate-50 hover:text-slate-900 rounded-xl font-normal text-sm lg:text-base transition">
            ...
            <div class="p-4 lg:p-6 space-y-2 mb-4 border-t border-slate-100 pt-6">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button
                        type="submit"
                        class="w-full flex items-center gap-4 px-5 py-3.5 text-red-600 hover:bg-red-50 rounded-xl font-normal text-sm lg:text-base transition">
        ...
        <main class="flex-1 flex flex-col h-screen overflow-y-auto relative w-full">
            <header class="h-20 lg:h-24 bg-white sm:bg-transparent border-b sm:border-none border-slate-200 flex items-center px-4 sm:px-10 lg:px-12 flex-shrink-0 w-full sticky top-0 z-10">
                <button
                    ...
                    class="lg:hidden p-2 mr-3 text-slate-600 hover:bg-slate-100 rounded-lg transition">
                ...
                <div class="relative w-full max-w-lg hidden md:block">
                    ...
                    <input
                        ...
                        class="w-full pl-13 pr-5 py-3.5 bg-white border border-slate-200 rounded-full text-base focus:outline-none focus:border-sky-900 shadow-sm transition">
                ...
                <div class="flex items-center gap-5 ml-auto">
                    <div class="text-right hidden sm:block">
                        ...
                        <p class="text-xs text-slate-500 font-normal">
                            {{ $latestOrder->package->name ?? 'No Plan' }}
                        </p>
                    ...
                    <a
                        ...
                        class="w-12 h-12 rounded-full bg-slate-200 overflow-hidden border border-slate-200 hover:ring-2 hover:ring-sky-100 transition shrink-0 shadow-sm">
            ...
            <div class="p-6 sm:p-10 lg:p-12 pt-4 max-w-[1440px] mx-auto w-full">
                ...
                <div class="mb-10 lg:mb-12">
                    ...
                    <h1 class="text-3xl lg:text-4xl font-light text-slate-800 tracking-tight">
                        Welcome back,
                        <span class="font-normal text-slate-900">
                            {{ $firstName }}!
                        </span>
                    </h1>
                    <p class="text-base text-slate-500 mt-2 font-normal">
                        Your digital shop is looking great today. Manage your website and keep your content up to date.
                    </p>
                </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-10 lg:mb-12">
                        <div class="bg-white rounded-[2rem] p-6 lg:p-8 shadow-sm border border-slate-200 flex flex-col justify-between h-40 sm:h-48 transition-shadow hover:shadow-md">
                            <div class="flex justify-between items-start">
                                ...
                                <span class="text-[10px] lg:text-xs font-normal uppercase tracking-wider text-slate-400">
                                    System Status
                                </span>
                            ...
                            <div>
                                ...
                                <p class="text-xs lg:text-sm text-slate-500 mb-1 font-normal">
                                    Status
                                </p>

                                <div class="flex items-center gap-3">

                                    <h3 class="text-2xl lg:text-3xl font-bold text-slate-900 capitalize">
                                        {{ $latestOrder->website->status ?? 'Active' }}
                                    </h3>
                        ...
                        <div class="bg-white rounded-[2rem] p-6 lg:p-8 shadow-sm border border-slate-200 flex flex-col justify-between h-40 sm:h-48 transition-shadow hover:shadow-md">
                            ...
                            <div>
                                ...
                                <h3 class="text-xl lg:text-2xl font-normal text-slate-900 truncate">
                        ...
                        <div class="bg-white rounded-[2rem] p-6 lg:p-8 shadow-sm border border-slate-200 flex flex-col justify-between h-40 sm:h-48 transition-shadow hover:shadow-md">
                            ...
                            <div>
                                ...
                                <p class="text-xs lg:text-sm text-slate-400 mt-1 font-normal">
                                    Renews on
                                    {{ \Carbon\Carbon::parse($latestOrder->website->expires_at ?? now()->addYear())->format('M d, Y') }}
                                </p>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                        ...
                        <div class="lg:col-span-2 bg-gradient-to-br from-slate-50 to-sky-50/40 rounded-[2rem] p-8 sm:p-12 lg:p-14 border border-slate-200 shadow-sm relative overflow-hidden flex flex-col justify-center min-h-[300px]">
                            ...
                            <div class="relative z-10 max-w-2xl">
                                ...
                                <div class="flex flex-col sm:flex-row gap-4 mt-10">
                                    ...
                                    <a
                                        href="#"
                                        class="px-8 py-4 bg-[#0369a1] hover:bg-[#0284c7] text-white text-base font-normal rounded-xl shadow-md transition text-center">
                                    ...
                                    <a
                                        href="http://{{ $latestOrder->domain_name }}"
                                        target="_blank"
                                        class="px-8 py-4 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 text-base font-normal rounded-xl transition flex items-center justify-center gap-3">
                        ...
                        <div class="space-y-6 lg:space-y-8 flex flex-col">
                                ...
                                <div class="space-y-0 relative before:absolute before:inset-0 before:ml-2.5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-100 before:to-transparent">
                                    ...
                                    <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active pb-8">
                                        ...
                                        <div class="pl-8">
                                            ...
                                            <p class="text-sm font-normal text-slate-800">
                                                Price update on "Silk Scarf"
                                            </p>
                            ...
                            <div class="bg-gradient-to-br from-sky-50 to-blue-50/50 rounded-[2rem] p-8 border border-sky-100 shadow-sm shrink-0">
                                ...
                                <a
                                    href="#"
                                    class="inline-block mt-4 text-xs font-bold uppercase tracking-wider text-[#0369a1] hover:text-[#0284c7] transition">
                ...
                @else
                    ...
                    <div class="bg-white rounded-[2rem] border border-slate-200 shadow-sm p-16 lg:p-24 text-center mt-8">
                        ...
                        <div class="w-20 h-20 bg-sky-50 rounded-full flex items-center justify-center mx-auto text-[#0369a1] mb-6">
                            ...
                            <svg
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                    stroke-width="2"
                                    d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2h0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10">
                                </path>
                        ...
                        <h2 class="text-2xl lg:text-3xl font-bold text-slate-900 mb-3">
                            Belum Ada Website Aktif
                        </h2>

                        <p class="text-base text-slate-500 max-w-lg mx-auto leading-relaxed">
                            Anda belum memiliki layanan yang aktif. Silakan pilih template dan berlangganan untuk meluncurkan website Anda.
                        </p>

                        <a
                            href="{{ route('order.template') }}"
                            class="inline-block mt-8 px-8 py-4 bg-[#0369a1] hover:bg-[#0284c7] text-white text-base font-bold rounded-xl shadow-md transition">
